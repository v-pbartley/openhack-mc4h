...
- Review the main [Readme.md](https://github.com/microsoft/fhir-starter#fhir-starter) for the FHIR-Starter repo, and then review the [Readme.md](https://github.com/microsoft/fhir-starter/blob/main/scripts/Readme.md) in the ```fhir-starter/scripts``` directory.  
...
Be certain to enter ```y``` (for "yes") when prompted to generate a Postman environment for Azure API for FHIR access.
...
__Note:__  During the live MC4H OpenHack session, Resource Group names will be assigned. If you are performing the OpenHack on your own, you can use your own custom Resource Group name, or you can use the automatically-generated name provided in the install process. Whether you use a custom or automatically generated Resource Group name, make sure to take note of the name because you will need it later when installing additional Azure components.
