...
Component View of FHIR-Proxy and Azure API for FHIR with Azure Active Directory service principals as [confidential clients](https://docs.microsoft.com/en-us/azure/healthcare-apis/azure-api-for-fhir/register-confidential-azure-ad-client-app).
