...
In this challenge you will learn about the data mapping that relates parts of the Azure API for FHIR data store with the Dynamics health industry data model. 
