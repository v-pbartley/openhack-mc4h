...
## Backgound 
This OpenHack will help users gain skills in deploying Azure API for FHIR, FHIR-Proxy, Dynamics/Dataverse MC4H solutions, and supporting tools. After completing the MC4H OpenHack, you will be able to build the architectures highlighted on __[Microsoft Health Architectures](https://microsoft.github.io/health-architectures/)__.
