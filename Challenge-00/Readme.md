...
## Introduction 
Welcome to the Microsoft Cloud for Healthcare (MC4H) OpenHack! In this preliminary challenge, you will be checking your Azure environment and other components to make sure that you can deploy the tools used in this OpenHack. Please make certain that all of the prerequisites are in place before proceeding to the next challenge.
